...
#将原始输入转变为lil_matrix格式
def feature_a(inputs):
    featurea = reshape(256)(inputs)
    featurea = sp.lil_matrix(featurea)
    return featurea
...
features = feature_a(input_supply)
...
hidden1 = 16
#第一层的输入维度
H_1 = tf.keras.layers.TimeDistributed(GraphConvolution(input_dim=input_dim,
                                                                  output_dim=hidden1,
